        ...
        <div id="page">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo @get_current_user(); ?> - <?php echo $_SERVER['SERVER_NAME']; ?>(<?php
...
<?php endif; ?>
            ...
            <table>
                ...
                <tr><th colspan="4">PHP相关参数 <?php echo get_cfg_var("extension_dir"); ?></th></tr>
...
<?php echo (false !== eregi("phpinfo", $disFuns)) ? '<font color="red">×</font>' : "<a href='$phpSelf?act=phpinfo' target='_blank'>PHPINFO</a>"; ?>
                ...
                <tr>
                    ...
                    <tr>
                        <td>发送邮件地址：</td>
                        <td><?php echo get_cfg_var("sendmail_from") ? get_cfg_var("sendmail_from") : '<font color="red">×</font>'; ?></td>
                        <td>发送邮件路径 ：</td>
                        <td><?php echo get_cfg_var("sendmail_path") ? get_cfg_var("sendmail_path") : '<font color="red">×</font>'; ?></td>
                    </tr>
                    <tr>
