...
class lcl_database {
    ...
    public static function fetch_all_by_sql($where, $order = '', $start = 0, $limit = 0, $count = 0, $alias = '') {
    ...
    public static function checkquery($sql) {
        return lcl_database_safecheck::checkquery($sql);
    }
