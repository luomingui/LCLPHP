    ...
    public static function multi($num, $perpage, $curpage, $mpurl, $maxpages = 0, $page = 10, $autogoto = FALSE, $simple = FALSE, $jsfunc = FALSE) {
        ...
        if (defined('IN_ADMINCP')) {
            ...
            if (defined('IN_MOBILE') && !defined('TPL_DEFAULT')) {
                $lang['prev'] = lang('admincp', 'prevpage');
                $lang['next'] = lang('admincp', 'nextpage');
            } else {
                $lang['prev'] = '&nbsp;&nbsp;';
                $lang['next'] = lang('admincp', 'nextpage');
            }
            $lang['pageunit'] = lang('admincp', 'pageunit');
            $lang['total'] = lang('admincp', 'total');
            $lang['pagejumptip'] = lang('admincp', 'pagejumptip');
        }
        if (defined('IN_MOBILE') && !defined('TPL_DEFAULT')) {
            $dot = '..';
